...
下列图片由发布者补充。截图文件放入 `docs/images/` 后，README 会自动展示。
...
请按以下名称保存截图，以便自动出现在本页：

| 文件名 | 建议内容 |
| --- | --- |
| `docs/images/01-editor-overview.png` | 编辑页全貌，显示工具、图层和场段图 |
| `docs/images/02-track-properties.png` | 选中股道后的属性配置区 |
| `docs/images/03-runtime-map.png` | 运行作业页，显示车辆、安全设备和图例 |
| `docs/images/04-fullscreen-map.png` | 全屏大屏页，显示图例与标语 |
